        ...
        <nav class="navbar navbar-dark navbar-expand-sm pb-0">
          <div class="container-fluid border-bottom d-flex justify-content-between" style="height: 130px">
            <div class="row d-flex align-items-center">
              ...
              <div class="col" style="font-family: 'Noto Sans KR', sans-serif">
                <div class="color">
                  <a href="/mypage" class="nav-link fw-bold text-nowrap" style="font-size: 1.2rem">MY</a>
                </div>
              </div>
              <sec:authorize access="hasRole('ROLE_ADMIN')">
                ...
                <div class="col" style="font-family: 'Noto Sans KR', sans-serif">
                  <div class="color">
                    <a href="/admin/adminInquiry" class="nav-link fw-bold text-nowrap" style="font-size: 1.2rem">1대1 문의
                      관리</a>
                  </div>
                </div>
              </sec:authorize>
            ...
            <div class="text-end">
              ...
              ">
                    <div class="row">
                      ...
                      <ul class="col">
                        <a href="/cs/noticeList" class="dropdown-item fw-bold">공지사항</a>
                        <div class="pt-3">&nbsp;</div>
