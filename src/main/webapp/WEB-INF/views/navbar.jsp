    ...
    <%@ taglib uri="http://www.springframework.org/security/tags" prefix="sec" %>
      ...
      <header style="background-color: whigt">
        <nav class="navbar navbar-dark navbar-expand-sm pb-0">
          <div class="container-fluid border-bottom d-flex justify-content-between pt-3 pb-3" style="height: auto">
            <div class="row d-flex align-items-center w-100">
              ...
              <div class="col ps-5">
                <div class="row">
                  ...
                  <div class="col-xl-1 col-md-4 col-sm-6" style="font-family: 'Noto Sans KR', sans-serif">
                    <div class="color">
                  ...
                  <sec:authorize access="hasRole('ROLE_ADMIN')">
                    <div class="col-xl-2 col-md-6 col-sm-6" style="font-family: 'Noto Sans KR', sans-serif">
                      <div class="color">
                        <a href="/admin/adminBoard/1" class="nav-link fw-bold text-nowrap" style="font-size: 1.2rem">게시판
                          관리</a>
                      </div>
                    </div>
                    <div class="col-xl-2 col-md-6 col-sm-6" style="font-family: 'Noto Sans KR', sans-serif">
                      <div class="color">
                        <a href="/admin/adminUsers/1" class="nav-link fw-bold text-nowrap" style="font-size: 1.2rem">사용자
                          관리</a>
                      </div>
                    </div>
                    <div class="col-xl-2 col-md-6 col-sm-6" style="font-family: 'Noto Sans KR', sans-serif">
                      <div class="color">
                        <a href="/admin/adminInquiry/1" class="nav-link fw-bold text-nowrap"
                          style="font-size: 1.2rem">1대1 문의 관리</a>
                      </div>
                    </div>
                    <div class="col-xl-1 col-md-6 col-sm-6" style="font-family: 'Noto Sans KR', sans-serif">
                      <div class="color">
                        <a href="/admin/adminManagementShipment/1" class="nav-link fw-bold text-nowrap"
              ...
              <div class="col">
                <div class="navbar-nav d-flex justify-content-end"
                  ...
                  <div class="navbar flex-column text-end" id="">
                          ...
                          <div class="row d-flex align-items-center">
                            ...
                            <div class="col-auto">
                              <form method="post" action="/logout">
                                <button class="btn text-nowrap fw-bold pe-0"
                    ...
                    <div style="font-family: 'Noto Sans KR', sans-serif" class="w-100">
                      <div class="dropdown dropstart">
                        <a href="" class="text-dark dropdown-toggle" style="text-decoration: none"
                          ...
                          <div class="row">
                            <ul class="col">
                              <span id="submenu01_span">
                                <a href="" id="submenu01" class="dropdown-item dropdown-submenu01 fw-bold">
                                  예약하기
                                </a>
                                <!-- 예약하기 상세 메뉴 -->
                                <div id="dropdown_submenu01" class="dropdown-menu ps-2 pe-2" style="font-size: 0.8rem">
                                  <a href="/home/termsForHome" class="text-dark pe-2"
                                    style="text-decoration: none">방문택배접수</a>
                                  <a href="/home/termsForHomeBulk" class="text-dark pe-2"
                                    style="text-decoration: none">다량접수</a>
                                  <sec:authorize access="isAnonymous()">
                                    <a href="#" onclick="doAlert()" class="text-dark"
                                      style="text-decoration: none">프리미엄접수</a>
                                  </sec:authorize>
                                  <sec:authorize access="isAuthenticated()">
                                    <a href="/home/reservationSender" class="text-dark"
                                      style="text-decoration: none">프리미엄접수</a>
                                  </sec:authorize>
                                </div>
                              </span>
                              ...
                              <span id="submenu02_span">
                                <a href="" id="submenu02" class="dropdown-item dropdown-submenu02 fw-bold">
                                  예약내역 조회
                                </a>
                                <!-- 예약내역 조회 상세 메뉴 -->
                                <div id="dropdown_submenu02" class="dropdown-menu ps-2 pe-2" style="font-size: 0.8rem">
                                  <!-- <a href="" class="text-dark pe-2" style="text-decoration: none">홈 프리미엄</a> -->
                                  <a href="/delivery/searchTrackingNumber" class="text-dark pe-2"
                                    style="text-decoration: none">운송장 조회</a>
                                </div>
                              </span>
                              ...
                              <span id="submenu03_span">
                                <a href="" id="submenu03" class="dropdown-item dropdown-submenu03 fw-bold">
                                  이용안내
                                </a>
                                <!-- 이용안내 상세 메뉴 -->
                                <div id="dropdown_submenu03" class="dropdown-menu ps-2 pe-2" style="font-size: 0.8rem">
                                  <a href="/guide/guideHome" class="text-dark pe-2" style="text-decoration: none">택배
                                    이용안내</a>
                                  <a href="/guide/guidePackaging" class="text-dark pe-2"
                                    style="text-decoration: none">포장안내</a>
                                  <a href="/guide/guideImpossible" class="text-dark" style="text-decoration: none">이용불가
                                    상품</a>
                                </div>
                              </span>
                              ...
                              <span id="submenu04_span">
                                <a href="" id="submenu04" class="dropdown-item dropdown-submenu04 fw-bold">
                                  회원 혜택
                                </a>
                                <!-- 회원 혜택 상세 메뉴 -->
                                <div id="dropdown_submenu04" class="dropdown-menu ps-2 pe-2" style="font-size: 0.8rem">
                                  <a href="/grade/gradeBenefit" class="text-dark pe-2" style="text-decoration: none">등급별
                                    혜택</a>
                                </div>
                              </span>
                            </ul>
                            <ul class="col">
                              ...
                              <a href="/event/eventList/1" class="dropdown-item fw-bold">이벤트</a>
                            </ul>
                          </div>
                        </div>
                      </div>
