    ...
    >
      <div class="container" style="width: 650px">
        ...
        >
            ...
            <div class="col">
              ...
              <div>
                ...
                <span
                  ...
                  >${_resultOne.ITEM_TYPE_DESCRIPTION}</span
                >
              </div>
            </div>
            <div class="col-auto">
          ...
          <c:set
            var="PROGRESS_STATUS_DESCRIPTION"
            value="${_resultOne.PROGRESS_STATUS_DESCRIPTION}"
          />
          <div
            class="p-4 mt-4"
            style="
          ...
          >
            ...
            >
              <div class="col d-flex flex-column justify-content-center">
                ...
                <div
                  class="text-center ${PROGRESS_STATUS_DESCRIPTION == '접수완료' ? 'greenForText' : '' } pt-2"
                >
                  접수완료
                </div>
              </div>
              ...
              <div class="col">
                ...
                <div
                  class="text-center ${PROGRESS_STATUS_DESCRIPTION == '수거완료' ? 'greenForText' : '' } pt-2"
                >
                  수거완료
                </div>
              </div>
              ...
              <div class="col">
                ...
                <div
                  class="text-center ${PROGRESS_STATUS_DESCRIPTION == '배송중' ? 'greenForText' : '' } pt-2"
                >
                  배송중
                </div>
              </div>
              ...
              <div class="col">
                ...
                <div
                  class="text-center ${PROGRESS_STATUS_DESCRIPTION == '배송완료' ? 'greenForText' : '' } pt-2"
                >
                  배송완료
                </div>
              </div>
          ...
          >
            <div class="row d-flex align-items-center mt-4">
              <div
                class="col-auto fw-bold ${listCount == loop.count ? 'darkFortext' : 'grayForText' }"
              >
                <div>${_resultList.PROGRESS_STATUS_TIME}</div>
              </div>
              <div class="col-auto">
                <div
                  class="${listCount == loop.count ? 'greenForDot' : 'grayForDot' }"
          ...
          <div class="row d-flex align-items-center mt-5">
            <div
              class="col-auto fw-bold ${PROGRESS_STATUS_DESCRIPTION == '수거완료' ? 'darkFortext' : 'grayForText' }"
            >
              <div>2023-02-16</div>
              <div>16:39</div>
            </div>
            <div class="col-auto">
              <div
                class="${PROGRESS_STATUS_DESCRIPTION == '수거완료' ? 'greenForDot' : 'grayForDot' }"
                style="width: 15px; height: 15px; border-radius: 50%"
              ></div>
            </div>
            <div
              class="col fs-5 fw-bold ${PROGRESS_STATUS_DESCRIPTION == '수거완료' ? 'darkForText' : 'grayForText' }"
            >
              수거완료
            </div>
          </div>
          <div class="row d-flex align-items-center mt-5">
            <div
              class="col-auto fw-bold ${PROGRESS_STATUS_DESCRIPTION == '배송중' ? 'darkFortext' : 'grayForText' }"
            >
              <div>2023-02-16</div>
              <div>16:39</div>
            </div>
            <div class="col-auto">
              <div
                class="${PROGRESS_STATUS_DESCRIPTION == '배송중' ? 'greenForDot' : 'grayForDot' }"
                style="width: 15px; height: 15px; border-radius: 50%"
              ></div>
            </div>
            <div
              class="col fs-5 fw-bold ${PROGRESS_STATUS_DESCRIPTION == '배송중' ? 'darkForText' : 'grayForText' }"
            >
              배송중
            </div>
          </div>
          <div class="row d-flex align-items-center mt-5">
            <div
              class="col-auto fw-bold ${PROGRESS_STATUS_DESCRIPTION == '배송완료' ? 'darkFortext' : 'grayForText' }"
            >
              <div>2023-02-16</div>
              <div>20:39</div>
            </div>
            <div class="col-auto">
              <div
                class="${PROGRESS_STATUS_DESCRIPTION == '배송완료' ? 'greenForDot' : 'grayForDot' }"
                style="width: 15px; height: 15px; border-radius: 50%"
              ></div>
            </div>
            <div
              class="col fs-5 fw-bold ${PROGRESS_STATUS_DESCRIPTION == '배송완료' ? 'darkForText' : 'grayForText' }"
            >
              배송완료
            </div>
          </div>
