<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <body>
    ...
    <main style="font-family: 'Noto Sans KR', sans-serif">
      <div class="fs-3 fw-bold d-flex align-items-center justify-content-center" style="height: 4rem">
        운송장조회
      </div>
      ...
      <div class="container">
        <div class="col-auto">
          ...
          <div class="d-flex row justify-content-center text-center">
            <div class="border p-5" style="border-radius: 20px; background-color: white; width: 500px">

              <div>
                <span class="tracking-list-icon">
                  <img src="/resources/images/box.png" alt="" width="150px" />
                </span>
              </div>
              <div class="p-3" style="color: gray">
                <h4>귀하의 운송장 번호는</h4>
                <h4>${resultMap.TRACKING_NUMBER} 입니다.</h4>
              </div>
            </div>
          </div>
          ...
          <div class="fs-3 fw-bold text-center" style="padding-bottom: 200px">
            <span style="width: 100px">
              <input type="button" class="btn text-light" style="width:85px ;background-color: #a5a5a5; color: white"
                value="BACK" onClick="history.go(-1)">

              <a href="/delivery/trackShipment" class="btn text-light" style="background-color: rgb(55, 210, 67);
              color: rgb(55, 210, 67);">
                배송조회
              </a>
            </span>
