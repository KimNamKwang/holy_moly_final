      ...
      <form action="/common/join_step4" method="get">
        <div class="bg-white border text-start p-4" style="border-radius: 20px">
          <table class="table align-middle table-borderless">
            <input type="hidden" name="MARKETING_RECEIVE_ACCEPTION" value="${resultMap.MARKETING_RECEIVE_ACCEPTION}" />
            <input type="hidden" name="Name" value="${resultMap.Name}" />
            <input type="hidden" name="USER_UID" value="${resultMap.USER_UID}" />
            <input type="hidden" name="PASSWORD_NOT_ENCODED" value="${resultMap.PASSWORD}" />
            ...
            <tr>
              ...
              <td>
                <input type="date" class="form-control w-50" name="BIRTH_DATE" id="birth_date" required />
              </td>
            </tr>
            <tr>
              ...
              <td class="row">
                <div class="col-auto">
                  <select class="form-select" name="phoneFirst" id="phoneFirst" required>
                ...
                <div class="col-1">-</div>
                <div class="col">
                  <input type="tel" class="form-control text-center" id="phoneSecond" name="phoneSecond" maxlength="4"
                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required />
                </div>
                <div class="col-1">-</div>
                <div class="col">
                  <input type="tel" class="form-control text-center" id="phoneThird" name="phoneThird" maxlength="4"
                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required />
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <input type="email" class="form-control" name="E_MAIL" id="userEmail" minlength="5" placeholder="이메일 주소"
                  required />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="2">
                <input class="form-control" style="width: 150px" type="button" onclick="sample6_execDaumPostcode()"
                  value="우편번호 찾기" />
                <input class="col-10 form-control" type="text" id="sample6_postcode" name="POSTALCODE"
                ...
                <input class="form-control" type="text" class="col-10" id="sample6_detailAddress" name="DETAILADDRESS"
                  placeholder="상세주소" />
                <input class="form-control" type="text" id="sample6_extraAddress" name="EXTRAADDRESS"
                  placeholder="참고항목" />
              </td>
            </tr>
          </table>
        ...
        <div class="row">
          <div class="col mt-3">
            <a href="/common/join_step2" class="btn btn-sm" style="
                border-radius: 50px;
                color: white;
          ...
          <div class="col text-end mt-3" style="margin-bottom: 200px">
            <button class="btn btn-lg text-light fw-bold" style="
