    ...
    <div class="container" style="width: 600px">
      <form class="form-signin" method="post" action="/login">
        ...
        <div class="d-flex justify-content-center">
          <div class="bg-white border text-start w-100" style="
              border-radius: 20px;
            ...
            <div>
              ...
              <div>
                <input class="form-control form-check-input w-100" type="text" name="username" id="username"
                  placeholder="ID" required style="
                    height: 50px;
            ...
            <div>
              ...
              <div>
                <input class="form-control form-check-input w-100" type="password" id="password" name="password"
                  placeholder="PW" required style="
                    height: 50px;
                    border-radius: 10px 10px;
                    border-color: rgb(242, 242, 242);
                  " />
            ...
            <div class="row text-center pt-4" style="font-size: 0.8rem; color: rgb(143, 139, 133)">
            ...
            <div class="row text-center pt-4">
              <div class="col d-flex justify-content-center pe-0">
                <a href="/index" class="btn fw-bold d-flex align-items-center justify-content-center" style="
                    width: 150px;
                    height: 45px;
              ...
              <div class="col d-flex justify-content-center ps-0">
                <button type="submit" class="btn text-light fw-bold d-flex align-items-center justify-content-center"
                  style="
