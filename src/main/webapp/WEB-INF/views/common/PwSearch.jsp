  ...
  <body class="bg-light" style="font-family: 'Noto Sans KR', sans-serif">
    ...
    <div class="container" style="width: 600px">
      ...
      <form action="/common/login">
            ...
            <div>
              ...
              <div>
                <div class="input-group">
                  <input style="height: 50px; border-color: rgb(242, 242, 242)" id="phone" type="text"
                    class="form-control" placeholder="아이디" id="phone" />
                </div>
              </div>
              ...
              <div class="form-input form-input-ph ph-length6 mb0">
                <div class="auth">
                  <div class="input-group">
                    <input style="height: 50px; border-color: rgb(242, 242, 242)" id="phone" type="text"
                      class="form-control" placeholder="휴대폰 번호" id="phone" />
                  </div>
                  <br />
                </div>
              </div>
        ...
        <div class="row">
          <div class="col mt-3">
            <a href="/common/login" class="btn btn-sm" style="
                border-radius: 50px;
                color: white;
          ...
          <div class="col text-end mt-3">
            <button onclick="doAction()" class="btn btn-lg text-light fw-bold" style="
