            ...
            <main class="container" style="font-family: 'Noto Sans KR', sans-serif">
              <div class="mt-5">
                <form action="/home/payment" method="get">
                  ...
                  <table class="table table-bordered mb-5">
                    ...
                    <tbody>
                      <%-- 여기부터 input hidden으로 넘기는 parameter들 --%>
                        ...
                        <input type="hidden" name="SENDER_PHONE" value="${resultMap.SENDER_PHONE}" />
                        ...
                        <input type="hidden" name="DEPARTURE_EXTRAADDRESS"
                        ...
                        <input type="hidden" name="DESTINATION_POSTALCODE"
                        ...
                        <input type="hidden" name="TOTAL_PRICE_BEFORE_DISCOUNT"
                          value="${resultMap.NUMBER_OF_ITEMS * 3290}" />
                          ...
                          <%-- 여기까지 input hidden으로 넘기는 parameter들 --%>
                            ...
                            <tr>
                              ...
                              <td class="font07 last">
                                ${resultMap.NUMBER_OF_ITEMS * 3290} 원
                              </td>
                            </tr>
                    </tbody>
                  </table>
                            ...
                            <sec:authorize access="isAuthenticated()">
                              ...
                              <c:choose>
                                ...
                                <c:when test="${USER_GRADE_UID == 'GRADE_VV'}">
                                  ...
                                  <c:set var="TOTAL_PRICE"
                                    value="${(resultMap.NUMBER_OF_ITEMS * 3290) - resultMap.NUMBER_OF_ITEMS * 3290 * 0.08}" />
                                </c:when>
                                <c:otherwise>
                  ...
                  <div class="border border-1 mb-5 p-2">
                    ...
                    <div>
                      ${resultMap.DEPARTURE_ADDRESS}
                      ${resultMap.DEPARTURE_DETAILADDRESS}
                    </div>
                  </div>
                  ...
                  <div class="border border-1 p-2">
                    ...
                    <div>
                      (포장수량: ${resultMap.NUMBER_OF_ITEMS}
                      박스)-일반:${resultMap.NUMBER_OF_ITEMS}
                    </div>
                    <div>
                      물품:
              ...
              착불택배를 예약하신 경우,택배를 받으신 분이 착불택배비를 결제하지 않거나 로지아이 홈페이지의 결제페이지를 통하지 않고 택배기사에게 현금으로 지급한 경우,  예약 시 예치하신 착불보증금은 반환되지 않않으므로 택배를 받으시는 분께 착불요금 결제방법을 반드시 알려주시기 바랍니다. 특히 쇼핑몰 반품이나 AS를 위해 업체로 보내시는 경우, 로지아이 홈페이지에서 착불택배비 결제가능여부 협의 후 접수해 주시기 바랍니다. 
                  ...
                  <div class="d-flex justify-content-center mt-5" style="margin-bottom: 70px">
                    <a href="/home/reservationForHomeBulkStep2" class="btn btn-secondary me-3"
