      ...
      ">
          <div class="container pb-4" style="width: 45rem">
            <form action="/home/payment_completed" method="get">
              ...
              <div style="background-color: white; border-radius: 10px" class="p-3">
                ...
                <div>
                  ...
                  <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex">
                      ...
                      <a href="#" id="usePointbtn" class="text-nowrap btn text-light"
                ...
                <div class="mt-5">
                  ...
                  <table>
                    ...
                    <tr>
                      <td>할인/부가결제</td>
                      <%-- 로그인했다면 사용자 등급별로 할인 받는 금액 + 위에서 포인트로 충당한 비용 까지 제하기. --%>
                        <td style="text-align: end">
                ...
                <div class="mt-5">
                  ...
                  <div id="card" style="display: none">
                    <div>
                      <select name="cardSelect" id="cardSelect" class="form-select w-25">
                ...
                <div class="mt-5">
                  ...
                  <div>
                    <div class="pb-2" style="font-size: 1.1rem" id="checkbox_group">
                      ...
                      <label class="form-check-label" for="check_all">모든 약관동의</label>
                    </div>
                    <div class="pb-2" id="checkbox_group">
                      <input type="checkbox" class="form-check-input" id="check_1" name="check" />
                      <label class="form-check-label" for="check_1">[필수] 구매조건 확인 및 결제진행 동의</label>
                    </div>
                    <div class="pb-2" id="checkbox_group">
                      <input type="checkbox" class="form-check-input" id="check_2" name="check" />
                      <label class="form-check-label" for="check_2">[필수] 청약철회방침 동의</label>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row mb-5">
                <div class="col mt-3">
                  <a href="/home/reservationForHomeStep3" class="btn btn-sm btn-secondary"
                    style="border-radius: 50px">BACK</a>
                </div>
                <div class="col text-end mt-3">
                  <!--수정시 jquery attr href 링크 수정해야함 -->
                  <button type="submit" class="btn btn-lg text-light fw-bold" style="background-color: rgb(55, 210, 67)"
                    id="paymentBtn">
                    결제하기
                  </button>
                </div>
