        ...
        <body style="z-index: 1; font-family: 'Noto Sans KR', sans-serif">
          ...
          <div class="container text-center">
            ...
            <ul class="d-flex justify-content-center list-unstyled">
              <li class="fs-3 fw-bold pe-5" style="opacity: 0.5">
                <a href="/customer/faqList" id="how_to_use" class="text-decoration-none text-dark">
                  FAQ
                </a>
              </li>
          ...
          <div class="container-fluid" style="background-color: rgb(249, 249, 249); padding-bottom: 200px">
            <div class="d-flex row justify-content-center text-center">
              <div class="border p-5 m-5" style="border-radius: 20px; background-color: white; width: 710px">
                <div class="fs-5 pb-2">
                ...
                <div class="d-flex justify-content-center pb-4">
                  <div class="row">
                    <div class="col">
                      <sec:authorize access="isAnonymous()">
                        <a href="#" onclick="doAlert()" class="btn fw-bold" style="
                  ...
                  ">
                      ...
                      <sec:authorize access="isAuthenticated()">
                        <a href="/customer/inquiryList" class="btn fw-bold" style="
                    background-color: rgb(242, 255, 216);
                    color: rgb(55, 210, 67);
                    height: 45px;
                    width: 120px;
                  ...
                  ">
                    ...
                    <div class="col">
                      <a href="/customer/memberInquiry" class="btn text-light fw-bold" style="
