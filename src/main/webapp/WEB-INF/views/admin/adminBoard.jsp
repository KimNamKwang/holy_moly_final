...
<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <%@ taglib uri="http://www.springframework.org/security/tags" prefix="sec" %>
      <!DOCTYPE html>
      <html lang="en">
>>>>>>> 8b356d5ccf8e2204639cea06ef4fbdf6102853a8
        ...
        <main>
          <div class="container-fluid pt-5" style="background-color: rgb(249, 249, 249); padding-bottom: 200px">
            <div class="container">
              <div class="fs-2 fw-bold pb-3">게시판 관리</div>
              <div class="text-secondary">
                총 게시판수 : <span class="fw-bold">5</span>
              </div>
              <div class="ps-4 pe-4 mt-2 shadow-sm" style="background-color: white">
                <table class="table text-center border-none mb-0">
                  <thead class="border-bottom border-3">
                  ...
                  <tbody class="">
                    <tr>
                      <td>1</td>
                      <td>
                        <a href="#" data-bs-toggle="modal" class="text-dark">배송지연 안내</a>
                      </td>
                      <td>공지사항</td>
                      <td>2023-02-08 11:00:00</td>
                      <td>
                        <a href="#modalUpdate" data-bs-toggle="modal" class="btn btn btn-outline-dark btn-sm">수정</a>
