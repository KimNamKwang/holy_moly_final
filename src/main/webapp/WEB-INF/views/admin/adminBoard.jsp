            ...
            <div class="container">
              ...
              <div class="ps-4 pe-4 mt-2 shadow-sm" style="background-color: white">
                <table class="table text-center border-none mb-0">
                  ...
                  <tbody>
                    <c:forEach items="${resultMap.boardList}" var="_boardList" varStatus="loop">
                      <tr>
                        <td>
                          <c:out value="${loop.count}" />
                        </td>
                        <td>
                          <a href="#" class="text-dark">${_boardList.TITLE}</a>
                        </td>
                        <td>${_boardList.BOARD_TYPE_DESCRIPTION}</td>
                        <td>${_boardList.DATE_CREATED}</td>
                        <td>
                          <a href="/admin/adminBoardUpdate?COMMONBOARD_UID=${_boardList.COMMONBOARD_UID}"
                ...
                <div class="text-end pt-2 pb-2">
                  <a href="/admin/adminBoardCreate" class="btn btn btn-outline-dark btn-sm">게시글추가</a>
                </div>
                <div class="mt-2 pb-3">
