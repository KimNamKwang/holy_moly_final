<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <body style="height: 1500px">
    ...
    <!-- main -->
    <div class="container d-flex justify-content-center" style="width: 1000px; font-family: 'Noto Sans KR', sans-serif">
      <div class="row">
        <div class="col-10">
          ...
          <!-- 예약하기 -->
          <section class="d-flex justify-content-center" style="margin-top: 30px; padding-bottom: 40px; width: 1160px">
            <div class="row" id="menu_icons_first">
              <div class="col">
                <a href="/home/termsForHome" class="text-dark" style="text-decoration: none">
                  <div class="hover rounded-circle d-flex flex-column align-items-center justify-content-center" style="
                      width: 200px;
                      height: 200px;
                      background-color: rgb(247, 247, 247);
                    " id="home1">
                    <div>
                      <img src="/resources/images/홈.png" style="width: 60px; height: 60px" alt="" />
                    </div>
              ...
              <div class="col">
                <a href="/home/termsForHomeBulk" class="text-dark" style="text-decoration: none">
                  <div class="hover rounded-circle d-flex flex-column align-items-center justify-content-center" style="
                      width: 200px;
                      height: 200px;
                      background-color: rgb(247, 247, 247);
                    " id="home2">
                    <div>
                      <img src="/resources/images/다량택배.png" style="width: 60px; height: 60px" alt="" />
                    </div>
            ...
            <div class="row" id="menu_icons_second" style="display: none">
              <div class="col">
                <a href="/guide/guideHome" class="text-dark" style="text-decoration: none">
                  <div class="hover rounded-circle d-flex flex-column align-items-center justify-content-center" style="
                      width: 200px;
                      height: 200px;
                      background-color: rgb(247, 247, 247);
                    ">
                    <div>
                      <img src="/resources/images/택배이용안내.png" style="width: 80px; height: 80px" alt="" />
                    </div>
              ...
              <div class="col">
                <a href="/guide/guidePackaging" class="text-dark" style="text-decoration: none">
                  <div class="hover rounded-circle d-flex flex-column align-items-center justify-content-center" style="
                      width: 200px;
                      height: 200px;
                      background-color: rgb(247, 247, 247);
                    ">
                    <div>
                      <img src="/resources/images/포장안내.png" style="width: 60px; height: 60px" alt="" />
                    </div>
              ...
              <div class="col">
                <a href="/guide/guideImpossible" class="text-dark" style="text-decoration: none">
                  <div class="hover rounded-circle d-flex flex-column align-items-center justify-content-center" style="
                      width: 200px;
                      height: 200px;
                      background-color: rgb(247, 247, 247);
                    ">
                    <div>
                      <img src="/resources/images/이용불가상품.png" style="width: 60px; height: 60px" alt="" />
                    </div>
              ...
              <div class="col">
                <a href="/customer/faqList" class="text-dark" style="text-decoration: none">
                  <div class="hover rounded-circle d-flex flex-column align-items-center justify-content-center" style="
                      width: 200px;
                      height: 200px;
                      background-color: rgb(247, 247, 247);
                    ">
                    <div>
                      <img src="/resources/images/고객센터.png" style="width: 70px; height: 70px" alt="" />
                    </div>
            ...
            <div class="container">
              <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-indicators">
                  <button data-bs-target="#carouselId" data-bs-slide-to="0" class="active" style="
                      width: 10px;
                      height: 10px;
                      border-radius: 50%;
                      margin-right: 10px;
                    "></button>
                  <button data-bs-target="#carouselId" data-bs-slide-to="1"
